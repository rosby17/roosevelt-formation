...
export default function ServiceDetailClient({ params }: PageProps) {
            ...
            <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", height: "100%" }}>
              ...
              <div>
                ...
                {service.outOfStock ? (
                  ...
                  >
                    Épuisé — indisponible pour le moment
                  </div>
                ) : service.paymentOffer ? (
                  <button
                    onClick={() => openCheckout(service.paymentOffer!)}
                    style={{
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                  ...
                  <a
                    ...
                    style={{
                      ...
                      gap: 10,
                      width: "100%",
                      background: service.checkoutUrl.includes("wa.me") ? "#25D366" : "var(--red)",
                      color: "#fff",
                      padding: "16px",
                      borderRadius: 12,
                      fontSize: 16,
                      fontWeight: 700,
                      textDecoration: "none",
                      boxShadow: service.checkoutUrl.includes("wa.me") ? "0 6px 20px rgba(37,211,102,0.30)" : "0 6px 20px rgba(200,16,46,0.35)",
                      transition: "all 0.2s"
                    }}
                    onMouseEnter={(e) => (e.currentTarget.style.background = service.checkoutUrl.includes("wa.me") ? "#1ebe5e" : "var(--red-dim)")}
                    onMouseLeave={(e) => (e.currentTarget.style.background = service.checkoutUrl.includes("wa.me") ? "#25D366" : "var(--red)")}
                  >
                    {service.checkoutUrl.includes("wa.me") && (
                    ...
                    {service.checkoutUrl.includes("wa.me") ? "Me contacter sur WhatsApp" : "Accéder au service"}
                  </a>
                ) : (
